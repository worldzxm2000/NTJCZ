	...
	: QWidget(parent)
{
	...
	ui.TitleLabel_Name->setText(QString::fromLocal8Bit("农田智能监测站"));
	setWindowTitle(QString::fromLocal8Bit("农田智能监测站设备控制"));
	ui.EdateTimeEdit->setVisible(false);
	...
	ui.RdateTimeEdit->setDateTime(nowtime);
}
